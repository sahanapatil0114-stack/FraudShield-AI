...
-- Default credentials:
--   Admin: admin@fraudshield.ai / Admin@123
...
('Super Admin', 'admin@fraudshield.ai', '$2y$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', '+1-555-0100', 1),
('John Anderson', 'john@example.com', '$2y$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'user', '+1-555-0101', 1),
('Sarah Mitchell', 'sarah@example.com', '$2y$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'user', '+1-555-0102', 1),
('Mike Thompson', 'mike@example.com', '$2y$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'user', '+1-555-0103', 1),
('Emily Chen', 'emily@example.com', '$2y$12$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'user', '+1-555-0104', 1);

-- NOTE: The password hash above is the bcrypt hash of 'password' (the default).
-- For proper credentials, run the app and use the register form, OR update with:
-- UPDATE users SET password_hash = '$2y$12$ACTUAL_HASH' WHERE email = 'admin@fraudshield.ai';
